...
class Messages:
    ...
    class GitHub:
        ...
        class AI:
            ...
            AI_GENERATED_TRUNCATING: str = "⚠️  AI generated {actual_len} chars, truncating to {max_chars}"
            AI_GENERATED_EMPTY_SHORT: str = "⚠️  AI generated an empty or very short description."
            ...
            TITLE_TOO_LONG_WARNING: str = "  ⚠️  Title is {length} chars (recommended: ≤72)"
